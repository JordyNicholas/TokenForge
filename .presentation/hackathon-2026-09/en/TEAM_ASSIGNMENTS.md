...
| Break the agent? | B |
| Scale to org | A |
| vs Auto Memory / vendor dashboards | A |

## Pre-demo sign-off

- [ ] Slot and link confirmed
- [ ] All names assigned; timekeeper not presenting
- [ ] Each person read [`PRESENTER_RUNBOOK.md`](./PRESENTER_RUNBOOK.md)
- [ ] Dry run #1 completed
- [ ] Dry run #2 + mock Q&A completed
